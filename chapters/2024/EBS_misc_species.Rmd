---
title: 'Eastern Bering Sea – Miscellaneous benthic fauna'
...
```{r fig2, include = TRUE, echo = FALSE, fig.cap='\\label{fig:figs}Figure 2. Biomass index of Miscellaneous Species (eelpouts, poachers, sea stars) in eastern Bering Sea continental shelf survey strata 10-60 estimated from RACE Groundfish Assessment Program and Shellfish Assessment Program summer bottom trawl survey data from 1982 to 2024.'}
knitr::include_graphics('../plots/EBS/EBS_rema_misc_species_subarea_bar.png')
```
