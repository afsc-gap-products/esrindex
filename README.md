...
__Forage Fish, Jellyfish, Miscellaneous Benthic Fauna, and Structural Epifauna__
...
__Top groundfish biomass__

The package also includes a function (`plot_top_biomass()`) that retrieves and plots design-based biomass index time series and 95% confidence intervals for select taxa. Time series for these taxa utilize design-based mean and CV estimates __without__ rema.
